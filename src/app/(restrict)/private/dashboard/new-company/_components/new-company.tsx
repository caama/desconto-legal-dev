...
export function NewCompany({ cities, categories }: NewCompanyProps) {
  ...
  async function handleNewCompany(data: NewCompanyFormType) {
    ...
    setHasInvalidContractStart(false)
    setHasInvalidContractEnd(false)
    form.reset()
  ...
  return (
    <main className="mx-auto flex min-h-screen flex-col p-4">
      <Card className="pt-0">
        <CardHeader className="flex flex-col rounded-t-xl bg-primary px-6 py-4 sm:flex-row sm:items-center sm:justify-between">
